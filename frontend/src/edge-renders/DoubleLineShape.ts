import { AbstractCanvas2D, ArrowShape, Point } from "@maxgraph/core";

export default class DoubleLineShape extends ArrowShape {
    public static shapeKey: string = "DoubleLine";
